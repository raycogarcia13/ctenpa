...
<!--                <el-table-column fixed="right" prop="actividad" label="Actividad" width="120">-->
<!--                    <template slot-scope="scope">-->
<!--                        <el-input size="small"-->
<!--                                  style="text-align:center"-->
<!--                                  v-model="scope.row.actividad">-->
<!--                        </el-input>-->
<!--                    </template>-->
<!--                </el-table-column>-->
...
<!--                <el-table-column prop="pro_ratea" label="Pro Ratea" width="200">-->
<!--                    <template slot-scope="scope">-->
<!--                        <el-input size="small"-->
<!--                                  style="text-align:center"-->
...
<script>
    ...
    mounted() {
            this.getActividades();
            console.log(this.getProyectosById());
